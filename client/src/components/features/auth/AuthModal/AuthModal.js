...
import { Button, Modal, ModalHeader, ModalBody, Form, FormGroup, Input, Label, Col, ModalFooter, Alert } from 'reactstrap';

const AuthModal = ({ sendFormData, type, toggleModal, isOpen }) => {
  ...
  const submitForm = async (e) => {
    ...
    if (type === 'register' && name.length < 4) await setErrors((p) => [...p ,`Name can't be shorter than 4`]);
